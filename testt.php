...
$url = "https://api.themoviedb.org/3/trending/movies/day?api_key=d0c24266ec2ff53c34cff3cdf84890be";
$ch = curl_init($url);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
...
$url = "https://api.themoviedb.org/3/trending/tv/day?api_key=d0c24266ec2ff53c34cff3cdf84890be";
$ch = curl_init($url);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
